...
<body id="page-top">
  ...
  <!--/ Nav End /-->
  <!--/ Intro Skew Star /-->
  <div id="home" class="intro route bg-image" style="background-image: url(marriage.jpg)">
    <div class="overlay-itro"></div>
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <!--<p class="display-6 color-d">Hello, world!</p>-->
          <h1 class="intro-title mb-4">Royal Wedding Organizer</h1>
     ...
     <div class="card">
       <div class="card-header bg-info">
         <div class="row">
           ...
           <div class="col-md-2">Persons</div>
