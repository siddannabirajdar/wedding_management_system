                ...
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="vname" id="name" placeholder="Decoration Name" required="true">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="price" id="email" placeholder="Price" required="true">
                        </div>
                         <div class="form-group">
