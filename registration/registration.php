...
<body>
                ...
                <div class="signup-content">
                    <form method="POST" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" id="name" placeholder="User Name" required />
                        </div>
                         <div class="form-group">
                        ...
                        <div class="form-group">
                        <input type="submit" name="submit" id="submit" class="form-submit" href="venue.php" value="Submit"/>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        swal("After filling this form  please add services in service section ");
    </script>-->
</body>
</html>